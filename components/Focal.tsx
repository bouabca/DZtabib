...
function Focal() {
  return (
    <div className='w-full flex flex-col lg:flex-row p-[6%] justify-center items-center'>
        ...
        <div className='text-[20px]   text-center lg:text-start  lg:text-[30px] opacity-60 lg:w-[60%] '>We work only the best doctors  in different specialities in order to provide the best medical care to our patients, So don’t worry about anything and book yourself.</div>
        <a href="/book" >
